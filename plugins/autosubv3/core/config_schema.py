                ...
                },
                {
                    ...
                    "content": [
                        ...
                        },
                        {
                            "component": "VCol",
                            "props": {"cols": 12, "md": 4},
                            "content": [{"component": "VSwitch", "props": {"model": "use_hymt2", "label": "启用Hy-MT2专用翻译方案", "hint": "官方模板结构化批量翻译：行数严格保持、防合译错位、漏行自动重试+单行兜底（需在下方面板配置模型）"}}],
                        },
                    ],
                },
                {
                    ...
                    "content": [
                        {
                            "component": "VCol",
                            "props": {"cols": 12, "md": 4},
                            "content": [{"component": "VTextField", "props": {"model": "hy_mt2_url", "label": "Hy-MT2 API URL", "placeholder": "http://192.168.123.146:11436"}}],
                        },
                        {
                            "component": "VCol",
                            "props": {"cols": 12, "md": 4},
                            "content": [{"component": "VTextField", "props": {"model": "hy_mt2_key", "label": "Hy-MT2 API 密钥", "placeholder": "sk-xxx（Ollama可任意填写）"}}],
                        },
                        {
                            "component": "VCol",
                            "props": {"cols": 12, "md": 4},
                            "content": [{"component": "VTextField", "props": {"model": "hy_mt2_model", "label": "Hy-MT2 模型名称", "placeholder": "hymt2-q8"}}],
                        },
                    ],
                },
                {
                    ...
                    "content": [
                        {
                            "component": "VCol",
                            "props": {"cols": 12, "md": 4},
                            "content": [{"component": "VTextField", "props": {"model": "hy_mt2_batch_size", "label": "Hy-MT2 每批翻译行数", "placeholder": "20"}}],
                        },
                        {
                            "component": "VCol",
                            "props": {"cols": 12, "md": 4},
                            "content": [{"component": "VTextField", "props": {"model": "hy_mt2_context_window", "label": "Hy-MT2 上下文窗口大小", "placeholder": "10"}}],
                        },
                        {
                            "component": "VCol",
                            "props": {"cols": 12, "md": 4},
                            "content": [{"component": "VTextField", "props": {"model": "hy_mt2_max_retries", "label": "Hy-MT2 批次重试次数", "placeholder": "3"}}],
                        },
                    ],
                },
                {
                    ...
                    "content": [
                        {
                            "component": "VCol",
                            "props": {"cols": 12},
                            "content": [{"component": "VSwitch", "props": {"model": "hy_mt2_fallback", "label": "Hy-MT2 启用单行兜底", "hint": "重试后仍缺失的行，用前文上下文单独补译"}}],
                        },
                    ],
                },
            ],
